# -*- coding: utf-8 -*-
"""
FinalChance — Spella spell-book trading helper. CLI and library for listing, buying, querying spells and fees.
Single-file app for the Spella contract; use with SpellCast or headless. Upgraded from Wish with extra tools.
"""
...
def cmd_fee(args: argparse.Namespace) -> int:
    ...
    if getattr(args, "ether", None):
        print("Price: %s" % format_wei(price))
